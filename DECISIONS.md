...
| Embedding model          | `text-embedding-3-small` (OpenAI)                                                                                     | Simple API call, no local model download, no query-prefix needed; consistent with OpenAI provider already in use. Changed from `BAAI/bge-large-en-v1.5` before any ingestion was run (2026-06-29). |
